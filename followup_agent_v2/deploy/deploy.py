"""
Deploy the Follow-up Agent to Vertex AI Agent Engine.

Run from inside the project environment:

    cd agents/sales_iq/followup_agent_v2
...
def main():
    ...
    log.info("Importing Follow-up Agent...")
    ...
    log.info("Deploying Follow-up Agent...")
    log.info("Project : %s", PROJECT)
    log.info("Location: %s", LOCATION)

    with tempfile.TemporaryDirectory(
        prefix="followup_bundle_"
    ) as tmp:
        ...
        remote_app = agent_engines.create(
            ...
            display_name="SalesIQ - Follow-up Agent",
    ...
    print()
    print("=" * 70)
    print("Follow-up Agent deployed successfully!")
    print(resource_name)
    print("=" * 70)
    print()
